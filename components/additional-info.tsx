  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
      <WobbleCard
        ...
        className="" 
      >
        <Link href={'https://github.com/wajihT/text-behind-image'} target="_blank" rel="noopener noreferrer">
      ...
      <Link href={'https://x.com/bigunit_42'} target="_blank" rel="noopener noreferrer">
